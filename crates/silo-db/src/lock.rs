...
//!
//! This replaces the MVP's "last write to the index wins" race, where two
//! concurrent publishes to one repo/channel could each regenerate an index
//! from a view of the world that excluded the other's package.
